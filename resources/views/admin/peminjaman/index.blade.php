...
.badge-dibatalkan { background-color: #f3f4f6; color: #4b5563; }
...
<div class="w-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 lg:py-4">  
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-slate-600 dark:text-slate-400 text-base sm:text-lg flex items-center space-x-2">
                                ...
                                <span>Monitor dan kelola peminjaman barang inventaris secara efisien</span>
                            </p>
                            ...
                            <div class="flex flex-wrap items-center gap-3 mt-4">
                                <div class="flex items-center space-x-2 px-3 py-2 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-slate-200/50 dark:border-gray-600/50 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base font-bold text-slate-800 dark:text-slate-200">{{ $peminjaman->total() }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-2 px-3 py-2 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-amber-200/50 dark:border-amber-800/50 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base font-bold text-slate-800 dark:text-slate-200">{{ $peminjaman->where('status', 'menunggu')->count() }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row lg:flex-col gap-3">
                            {{-- Export Button --}}
                            <a href="{{ route('admin.peminjaman.export') }}" 
        ...
        <div class="mb-8 animate-professional-reveal delay-200">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Status Peminjaman</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Overview statistik peminjaman real-time</p>
                    </div>
                </div>
            ...
            <!-- Stats Cards Grid -->
            <div class="grid grid-cols-2 gap-3 lg:grid-cols-4 lg:gap-5 mb-0">
                    ...
                    <div class="relative p-4 sm:p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $peminjaman->total() }}</h3>
                                <span class="text-blue-100 text-sm">data</span>
                            </div>
                        </div>
                        
                        <!-- Footer -->
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-blue-100 text-xs font-medium">Semua peminjaman</span>
                            <i class="fas fa-file-alt text-blue-100 text-sm"></i>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center gap-1 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full">
                                ...
                                <span class="text-white text-xs font-bold">Urgent</span>
                            </div>
                        </div>
                        
                        <div class="space-y-2">
                            <p class="text-amber-100 text-sm font-medium">Menunggu Review</p>
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $peminjaman->where('status', 'menunggu')->count() }}</h3>
                                <span class="text-amber-100 text-sm">pending</span>
                            </div>
                        </div>
                        
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-amber-100 text-xs font-medium">Perlu persetujuan</span>
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-emerald-500 via-emerald-600 to-green-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div class="relative p-4 sm:p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $peminjaman->where('status', 'disetujui')->count() }}</h3>
                                <span class="text-emerald-100 text-sm">aktif</span>
                            </div>
                        </div>
                        
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-emerald-100 text-xs font-medium">Sedang berlangsung</span>
                ...
                <!-- Selesai Card -->
                <!-- Selesai Card -->
                <div class="group relative overflow-hidden bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 transition-transform duration-500"></div>
                    <div class="absolute bottom-0 left-0 w-24 h-24 bg-white/5 rounded-full -ml-12 -mb-12 transition-transform duration-500"></div>
                    ...
                    <div class="relative p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center gap-1 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full">
                                <i class="fas fa-circle-check text-white text-xs"></i>
                                <span class="text-white text-xs font-bold">Done</span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $peminjaman->where('status', 'selesai')->count() }}</h3>
                                <span class="text-indigo-100 text-sm">done</span>
                            </div>
                        </div>
                        
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-indigo-100 text-xs font-medium">Dikembalikan</span>
                            <i class="fas fa-undo text-indigo-100 text-sm"></i>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center gap-1 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full">
                                ...
                                <span class="text-white text-xs font-bold">Rejected</span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $peminjaman->where('status', 'ditolak')->count() }}</h3>
                                <span class="text-red-100 text-sm">rejected</span>
                            </div>
                        </div>
                        
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-red-100 text-xs font-medium">Tidak disetujui</span>
                            <i class="fas fa-ban text-red-100 text-sm"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400">Data diperbarui setiap kali ada perubahan status peminjaman</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                {{ $peminjaman->where('status', 'menunggu')->count() }} Perlu Review
                            </span>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                {{ $peminjaman->where('status', 'disetujui')->count() }} Aktif
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Filter data peminjaman sesuai kebutuhan</p>
                        </div>
                    </div>
                    ...
                    <form method="GET" action="{{ route('admin.peminjaman.index') }}">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select name="kategori" class="block w-full px-3 lg:px-4 py-2.5 lg:py-3 pr-10 text-sm lg:text-base bg-gray-50 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-4 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 focus:border-blue-500 dark:focus:border-blue-400 focus:bg-white dark:focus:bg-gray-600 transition-all text-gray-900 dark:text-gray-100 appearance-none cursor-pointer">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100">{{ $peminjaman->total() }}</span>
                                <span class="text-sm text-gray-600 dark:text-gray-400">Peminjaman</span>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden animate-professional-reveal delay-400">
            ...
            <div class="relative px-6 lg:px-8 py-6 bg-gradient-to-r from-gray-50 via-blue-50/30 to-indigo-50/30 dark:from-gray-700/50 dark:via-gray-800/50 dark:to-gray-700/50 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Daftar Peminjaman</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Kelola dan monitor semua data peminjaman</p>
                        </div>
                    </div>
                    <div class="hidden sm:flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-600 shadow-sm">
                        ...
                        <span class="font-bold text-gray-900 dark:text-gray-100">{{ $peminjaman->count() }}</span>
            ...
            <!-- Desktop Table - FIXED WIDTH ALIGNMENT -->
            <div class="hidden lg:block overflow-x-auto">
                <table class="w-full divide-y divide-slate-200 dark:divide-gray-700">
                        ...
                        <tr>
                            <th class="px-6 py-3 text-left" style="width: 18%;">
                                <div class="flex items-center gap-2 text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    <i class="fas fa-user text-blue-500 dark:text-blue-400 text-xs"></i>
                                    Peminjam
                                </div>
                            </th>
                            <th class="px-6 py-3 text-left" style="width: 28%;">
                                <div class="flex items-center gap-2 text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    <i class="fas fa-cube text-purple-500 dark:text-purple-400 text-xs"></i>
                                    Barang
                                </div>
                            </th>
                            <th class="px-6 py-3 text-left" style="width: 20%;">
                                <div class="flex items-center gap-2 text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    <i class="fas fa-calendar text-green-500 dark:text-green-400 text-xs"></i>
                                    Periode
                                </div>
                            </th>
                            <th class="px-6 py-3 text-left" style="width: 20%;">
                                <div class="flex items-center gap-2 text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    <i class="fas fa-info-circle text-amber-500 dark:text-amber-400 text-xs"></i>
                                    Status
                                </div>
                            </th>
                            <th class="px-6 py-3 text-center" style="width: 14%;">
                                <div class="flex items-center justify-center gap-2 text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    <i class="fas fa-cogs text-indigo-500 dark:text-indigo-400 text-xs"></i>
                                    Aksi
                                </div>
                            </th>
                        </tr>
                    ...
                    <tbody class="bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-gray-800 dark:via-gray-800/95 dark:to-gray-800/90 divide-y divide-slate-100 dark:divide-gray-700">
                        ...
                        <tr class="table-row">
                            <!-- Peminjam Column -->
                            <td class="px-6 py-4" style="width: 18%;">
                                <div class="flex items-center gap-2">
                                    <div class="relative flex-shrink-0">
                                        @if($item->user->avatar)
                                            <img src="{{ asset('storage/' . $item->user->avatar) }}" 
                                                alt="{{ $item->user->name }}"
                                                class="h-9 w-9 rounded-lg object-cover shadow-md border border-white dark:border-gray-700">
                                        @else
                                            <div class="h-9 w-9 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-md">
                                                <span class="text-white font-bold text-xs">{{ strtoupper(substr($item->user->name, 0, 2)) }}</span>
                                            </div>
                                        @endif
                                        <div class="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-green-500 rounded-full border border-white dark:border-gray-800"></div>
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <div class="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate" title="{{ $item->user->name }}">
                                            {{ Str::limit($item->user->name, 18) }}
                                        </div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400 truncate" title="{{ $item->user->email }}">
                                            {{ Str::limit($item->user->email, 20) }}
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <!-- Barang Column -->
                            <td class="px-6 py-4" style="width: 28%;">
                                @php
                                    $detailCount = $item->peminjamanDetail->count();
                                @endphp
                                
                                @if($detailCount > 1)
                                    <div>
                                        <div class="mb-2">
                                            <span class="inline-flex items-center px-2.5 py-1.5 rounded-lg text-xs font-bold bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-sm">
                                        ...
                                        <div class="space-y-2 max-h-36 overflow-y-auto pr-2 custom-scrollbar">
                                            @foreach($item->peminjamanDetail as $index => $detail)
                                                <div class="flex items-start text-xs bg-gradient-to-r from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800/50 rounded-lg p-2.5 border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-all">
                                                    <div class="flex-shrink-0 w-5 h-5 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center mr-2 font-bold text-[10px] shadow-sm">
                                                        {{ $index + 1 }}
                                                    </div>
                                                    <div class="flex-1 min-w-0">
                                                        <div class="font-semibold text-gray-900 dark:text-gray-100 truncate mb-1" title="{{ $detail->barang->nama_barang }}">
                                                            {{ $detail->barang->nama_barang }}
                                                        </div>
                                                        <div class="flex items-center gap-1.5 flex-wrap">
                                                            @if($detail->barang->kategori)
                                                                <span class="inline-flex items-center px-1.5 py-0.5 rounded bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 font-medium text-[10px]">
                                                                    <i class="fas fa-tag mr-1"></i>
                                                                    {{ $detail->barang->kategori->nama_kategori }}
                                                                </span>
                                                            @endif
                                                            <span class="inline-flex items-center px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-bold text-[10px]">
                                ...
                                @else
                                    @php
                                        $detail = $item->peminjamanDetail->first();
                                    @endphp
                                    @if($detail)
                                        <div>
                                            <div class="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-2 truncate" title="{{ $detail->barang->nama_barang }}">
                                                {{ $detail->barang->nama_barang }}
                                            </div>
                                            <div class="flex items-center gap-2 flex-wrap">
                                                @if($detail->barang->kategori)
                                                    <span class="inline-flex items-center px-2 py-1 rounded-lg bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-medium">
                                                        <i class="fas fa-tag mr-1"></i>
                                                        {{ $detail->barang->kategori->nama_kategori }}
                                                    </span>
                                                @endif
                                                <span class="inline-flex items-center px-2 py-1 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-bold">
                                                    <i class="fas fa-cubes mr-1"></i>
                                                    {{ $detail->jumlah }}x
                                                </span>
                                            </div>
                            ...
                            <td class="px-6 py-4" style="width: 20%;">
                                <div class="space-y-1.5">
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-gray-100">{{ \Carbon\Carbon::parse($item->tanggal_mulai)->format('d M Y') }}</span>
                                    </div>
                                    <div class="flex items-center gap-2 text-sm">
                                        <div class="p-1 bg-red-100 dark:bg-red-900/30 rounded">
                                            <i class="fas fa-calendar-check text-red-600 dark:text-red-400 text-xs"></i>
                                        </div>
                                        <span class="font-medium text-gray-900 dark:text-gray-100">{{ \Carbon\Carbon::parse($item->tanggal_selesai)->format('d M Y') }}</span>
                                    </div>
                                    <div class="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
                                        ...
                                        <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">
                                            @php
                                                $days = \Carbon\Carbon::parse($item->tanggal_mulai)->diffInDays(\Carbon\Carbon::parse($item->tanggal_selesai)) + 1;
                                            @endphp
                                            {{ $days }} hari
                                        </span>
                                    </div>
                            ...
                            <td class="px-6 py-4" style="width: 20%;">
                                <div class="space-y-2">
                                    @if($item->status == 'menunggu')
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 font-bold text-xs">
                                            <div class="w-2 h-2 bg-amber-500 rounded-full animate-pulse"></div>
                                            Menunggu
                                        </span>
                                    @elseif($item->status == 'disetujui')
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 font-bold text-xs">
                                            <div class="w-2 h-2 bg-emerald-500 rounded-full"></div>
                                            Disetujui
                                        </span>
                                    @elseif($item->status == 'ditolak')
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 font-bold text-xs">
                                            <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                                            Ditolak
                                        </span>
                                    @elseif($item->status == 'selesai')
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 font-bold text-xs">
                                            <div class="w-2 h-2 bg-indigo-500 rounded-full"></div>
                                            Selesai
                                        </span>
                                    @elseif($item->status == 'dibatalkan')
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-bold text-xs">
                                    ...
                                    @if($item->pembayaran)
                                        @if($item->pembayaran->status == 'lunas')
                                            <span class="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs font-bold">
                                                <i class="fas fa-check-circle"></i>
                                                Lunas
                                            </span>
                                        @elseif($item->pembayaran->status == 'pending')
                                            <span class="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 text-xs font-bold">
                            ...
                            <!-- Actions Column -->
                            <td class="px-6 py-4" style="width: 14%;">
                                @php
                                    $barangData = $item->peminjamanDetail->map(function($detail) {
                                        return [
                                            'nama' => $detail->barang->nama_barang,
                                            'jumlah' => $detail->jumlah,
                                            'kategori' => $detail->barang->kategori->nama_kategori ?? null
                                        ];
                                    });
                                @endphp
                                ...
                                <div class="flex items-center justify-center gap-1.5">
                                    ...
                                    class="p-2 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-lg transition-all transform hover:scale-110 shadow-sm" 
                                    title="Lihat Detail">
                                    ...
                                    @if($item->status == 'menunggu')
                                        ...
                                        class="p-2 text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/30 hover:bg-green-100 dark:hover:bg-green-900/50 rounded-lg transition-all transform hover:scale-110 shadow-sm" 
                                        title="Edit">
                                            <i class="fas fa-edit text-sm"></i>
                                        </a>
                                        <button onclick='approveModal(@json($item->id), @json($item->user->name), @json($barangData))'
                                                class="p-2 text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 rounded-lg transition-all transform hover:scale-110 shadow-sm" 
                                                title="Setujui">
                                            <i class="fas fa-check text-sm"></i>
                                        </button>
                                        <button onclick='rejectModal(@json($item->id), @json($item->user->name), @json($barangData))'
                                                class="p-2 text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 hover:bg-red-100 dark:hover:bg-red-900/50 rounded-lg transition-all transform hover:scale-110 shadow-sm" 
                                                title="Tolak">
                                    ...
                                    @if($item->status == 'disetujui')
                                        <button onclick='selesaiModal(@json($item->id), @json($item->user->name), @json($barangData))'
                                                class="p-2 text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 rounded-lg transition-all transform hover:scale-110 shadow-sm" 
                                                title="Selesaikan">
                    ...
                    <div class="bg-gradient-to-br from-white via-slate-50/50 to-blue-50/30 dark:from-gray-800 dark:via-gray-800/95 dark:to-gray-700/90 rounded-2xl p-5 border border-slate-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all">
                                ...
                                <div class="relative flex-shrink-0">
                                    ...
                                    @else
                                        <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
                                            <span class="text-white font-bold">{{ strtoupper(substr($item->user->name, 0, 2)) }}</span>
                                        </div>
                                    @endif
                                    <div class="absolute -bottom-1 -right-1 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-white dark:border-gray-800"></div>
                                </div>
                                <div class="min-w-0 flex-1">
                                    <div class="text-sm font-bold text-gray-900 dark:text-gray-100 truncate">{{ $item->user->name }}</div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ $item->user->email }}</div>
                                </div>
                            </div>
                            <div>
                                @if($item->status == 'menunggu')
                                ...
                                @elseif($item->status == 'selesai')
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 font-bold text-xs shadow-sm">
                                        <div class="w-2 h-2 bg-indigo-500 rounded-full"></div>
                                        Selesai
                                    </span>
                                @elseif($item->status == 'dibatalkan')
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-bold text-xs shadow-sm">
                                        <div class="w-2 h-2 bg-gray-500 rounded-full"></div>
                                        Dibatalkan
                                    </span>
                                @endif
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="bg-gradient-to-br from-green-50 to-emerald-50/50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-3 border border-green-200 dark:border-green-800">
                                    <div class="flex items-center gap-1.5 mb-1">
                                        <i class="fas fa-calendar text-green-600 dark:text-green-400 text-xs"></i>
                                        <span class="text-xs font-bold text-slate-700 dark:text-slate-300">Periode</span>
                                    </div>
                                    ...
                                    <div class="inline-flex items-center gap-1 px-2 py-0.5 bg-white dark:bg-gray-800 rounded-lg mt-1.5 border border-green-200 dark:border-green-800">
                                        <i class="fas fa-clock text-gray-500 dark:text-gray-400 text-xs"></i>
                                        <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">
                                            @php
                                                $days = \Carbon\Carbon::parse($item->tanggal_mulai)->diffInDays(\Carbon\Carbon::parse($item->tanggal_selesai)) + 1;
                                ...
                                <div class="bg-gradient-to-br from-blue-50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-3 border border-blue-200 dark:border-blue-800">
                                    <div class="flex items-center gap-1.5 mb-1">
                                        <i class="fas fa-money-bill-wave text-blue-600 dark:text-blue-400 text-xs"></i>
                                        <span class="text-xs font-bold text-slate-700 dark:text-slate-300">Biaya</span>
                                    </div>
                                    <div class="text-sm font-bold text-gray-900 dark:text-gray-100 mb-1">
                                        Rp {{ number_format($item->biaya, 0, ',', '.') }}
                                    </div>
                                    @if($item->pembayaran)
                                        @if($item->pembayaran->status == 'lunas')
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs font-bold">
                                                <i class="fas fa-check-circle"></i>
                                                Lunas
                                            </span>
                                        @elseif($item->pembayaran->status == 'pending')
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 text-xs font-bold">
                                                <i class="fas fa-clock"></i>
                                                Pending
                                            </span>
                                        @endif
                        ...
                        <div class="flex flex-wrap gap-2 pt-3 border-t border-slate-200 dark:border-gray-700">
                            ...
                            @if($item->status == 'menunggu')
                                ...
                                <button onclick='approveModal(@json($item->id), @json($item->user->name), @json($barangData))'
                                        class="inline-flex items-center px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold rounded-xl transition-all shadow-sm hover:shadow-md">
                            ...
                            @if($item->status == 'disetujui')
                                <button onclick='selesaiModal(@json($item->id), @json($item->user->name), @json($barangData))'
                                        class="inline-flex items-center px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white text-xs font-bold rounded-xl transition-all shadow-sm hover:shadow-md">
            ...
            <div class="bg-gradient-to-r from-slate-100 via-blue-50 to-indigo-50 dark:from-gray-700 dark:via-gray-800 dark:to-gray-700 px-6 py-6 border-t border-slate-200 dark:border-gray-600">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-3 px-4 py-2.5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 dark:border-gray-600">
                            ...
                            <div class="text-sm">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100 mx-1">{{ $peminjaman->firstItem() ?? 0 }}-{{ $peminjaman->lastItem() ?? 0 }}</span>
                                <span class="text-gray-600 dark:text-gray-400">dari</span>
                                <span class="font-bold text-blue-600 dark:text-blue-400 mx-1">{{ $peminjaman->total() }}</span>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="sm:hidden px-4 py-2.5 bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-600 shadow-sm">
                            <span class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $peminjaman->currentPage() }}</span>
                            <span class="text-sm text-gray-500 dark:text-gray-400 mx-1">/</span>
                            <span class="text-sm text-gray-600 dark:text-gray-300">{{ $peminjaman->lastPage() }}</span>
                        </div>
                        ...
                        <div class="relative">
                            <select id="page-select" onchange="window.location.href=this.value" 
                                ...
                                @for ($i = 1; $i <= $peminjaman->lastPage(); $i++)
                                    <option value="{{ $peminjaman->url($i) }}" {{ $i == $peminjaman->currentPage() ? 'selected' : '' }}>
                                        {{ $i }}
                                    </option>
                                @endfor
                            </select>
                ...
                <div class="mt-4 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 h-full rounded-full transition-all duration-500 shadow-lg" 
                         style="width: {{ ($peminjaman->currentPage() / $peminjaman->lastPage()) * 100 }}%">
                    </div>
                </div>
                ...
                <div class="mt-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500 dark:text-gray-400">
                    <div class="flex items-center gap-4">
                        <span class="flex items-center gap-1.5">
                            ...
                            Per halaman: <strong class="text-gray-700 dark:text-gray-300">{{ $peminjaman->count() }}</strong>
                        </span>
                        <span class="hidden sm:inline">•</span>
                        <span class="flex items-center gap-1.5">
                            <i class="fas fa-layer-group text-indigo-500 dark:text-indigo-400"></i>
                            Total halaman: <strong class="text-gray-700 dark:text-gray-300">{{ $peminjaman->lastPage() }}</strong>
                        </span>
                    </div>
                    
                    <div class="flex items-center gap-2">
                        @if ($peminjaman->currentPage() > 1)
                            <a href="{{ $peminjaman->url(1) }}" 
                        ...
                        @if ($peminjaman->currentPage() < $peminjaman->lastPage())
                            <a href="{{ $peminjaman->url($peminjaman->lastPage()) }}" 
                               class="px-3 py-1.5 bg-white dark:bg-gray-800 hover:bg-slate-50 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-all text-xs font-medium border border-slate-200 dark:border-gray-600">
                                Akhir
            ...
            <div class="px-6 py-16 text-center">
                <div class="max-w-sm mx-auto">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Tidak ada data peminjaman</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">
                        @if(request()->hasAny(['search', 'status', 'kategori', 'tanggal_mulai']))
                            Tidak ditemukan peminjaman yang sesuai dengan filter yang diterapkan.
                        @else
                            Belum ada peminjaman barang yang terdaftar dalam sistem.
                        @endif
                    </p>
                    @if(request()->hasAny(['search', 'status', 'kategori', 'tanggal_mulai']))
                        <a href="{{ route('admin.peminjaman.index') }}" 
                ...
                <form id="approve-form" method="POST" action="">
                    ...
                    <div class="mb-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                        <p class="text-sm text-green-800 dark:text-green-300 mb-3">
                            <span class="font-medium">Peminjam:</span> <span id="approve-user-name"></span>
                        </p>
                        
                        <!-- Container untuk list barang -->
                        <div id="approve-barang-list"></div>
                        
                        <p class="text-xs text-green-600 dark:text-green-400 mt-3" id="approve-summary">
                ...
                <form id="reject-form" method="POST" action="">
                    ...
                    <div class="mb-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                        <p class="text-sm text-red-800 dark:text-red-300 mb-3">
                            <span class="font-medium">Peminjam:</span> <span id="reject-user-name"></span>
                        </p>
                        
                        <!-- Container untuk list barang -->
                        <div id="reject-barang-list"></div>
                    </div>
    ...
    <div id="selesai-modal" class="fixed inset-0 modal-backdrop overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border-0 w-11/12 max-w-md shadow-2xl rounded-xl bg-white dark:bg-gray-800">
            <div class="mt-3">
                ...
                <form id="selesai-form" method="POST" action="">
                    @csrf
                    <div class="mb-4 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
                        <p class="text-sm text-indigo-800 dark:text-indigo-300 mb-3">
                            <span class="font-medium">Peminjam:</span> <span id="selesai-user-name"></span>
                        </p>
                        
                        <!-- Container untuk list barang -->
                        <div id="selesai-barang-list"></div>
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="submit" 
                                class="px-4 py-2 text-white bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 rounded-lg font-medium transition-all shadow-md hover:shadow-md">
...
<script>
// ============================================
// MODAL FUNCTIONS - Updated untuk Multiple Barang
// ============================================

function approveModal(id, userName, barangData) {
    document.getElementById('approve-user-name').textContent = userName;
    
    let barangList = [];
    try {
        barangList = typeof barangData === 'string' ? JSON.parse(barangData) : barangData;
    } catch (e) {
        console.error('Error parsing barangData:', e);
        barangList = [{ nama: barangData, jumlah: 1 }];
    }
    
    const barangContainer = document.getElementById('approve-barang-list');
    let barangHTML = '';
    
    if (Array.isArray(barangList) && barangList.length > 1) {
        barangHTML = '<div class="space-y-2 max-h-60 overflow-y-auto custom-scrollbar pr-2">';
        barangList.forEach((item, index) => {
            barangHTML += `
                <div class="flex items-start bg-white dark:bg-gray-800 rounded-lg p-2.5 border border-green-200 dark:border-green-800 hover:border-green-300 dark:hover:border-green-700 transition-all">
                    <div class="flex-shrink-0 w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 flex items-center justify-center text-xs font-bold mr-2.5">
                        ${index + 1}
                    </div>
                    <div class="flex-1 min-w-0">
        ...
        document.getElementById('approve-summary').innerHTML = `
            <i class="fas fa-layer-group mr-1"></i>
            Total ${barangList.length} barang akan dikurangi dari stok
        `;
    } else {
        const item = barangList[0] || { nama: barangData, jumlah: 1 };
        barangHTML = `
            <div class="text-sm text-green-800 dark:text-green-300">
                <span class="font-medium">Barang:</span> ${item.nama}
            </div>
            ${item.kategori ? `
    ...
    document.getElementById('approve-form').action = "/admin/peminjaman/" + id + "/approve";
    document.getElementById('approve-modal').classList.remove('hidden');
}

function rejectModal(id, userName, barangData) {
    ...
    const barangContainer = document.getElementById('reject-barang-list');
    let barangHTML = '';
    
    if (Array.isArray(barangList) && barangList.length > 1) {
        barangHTML = `<div class="text-sm font-medium text-red-900 dark:text-red-300 mb-2">
            <i class="fas fa-layer-group mr-1"></i>
            ${barangList.length} Barang
        </div>`;
        barangHTML += '<div class="space-y-1.5 max-h-48 overflow-y-auto custom-scrollbar pr-1">';
        barangList.forEach((item, index) => {
            barangHTML += `
                <div class="text-xs text-red-800 dark:text-red-300 bg-white dark:bg-gray-800 rounded p-2 border border-red-100 dark:border-red-800">
                    <span class="font-medium">${index + 1}.</span> ${item.nama} 
                    <span class="text-red-600 dark:text-red-400">(${item.jumlah}x)</span>
                    ${item.kategori ? `<span class="text-gray-500 dark:text-gray-400 ml-1">- ${item.kategori}</span>` : ''}
                </div>
            `;
        });
        barangHTML += '</div>';
        ...
        barangHTML = `
            <div class="text-sm text-red-800 dark:text-red-300">
                <span class="font-medium">Barang:</span> ${item.nama}
                ${item.jumlah ? ` <span class="text-red-600 dark:text-red-400">(${item.jumlah}x)</span>` : ''}
            </div>
            ${item.kategori ? `
    ...
    barangContainer.innerHTML = barangHTML;
    document.getElementById('reject-form').action = "/admin/peminjaman/" + id + "/reject";
    document.getElementById('reject-modal').classList.remove('hidden');
}

function selesaiModal(id, userName, barangData) {
    document.getElementById('selesai-user-name').textContent = userName;
    ...
    const barangContainer = document.getElementById('selesai-barang-list');
    let barangHTML = '';
    
    if (Array.isArray(barangList) && barangList.length > 1) {
        barangHTML = `<div class="text-sm font-medium text-indigo-900 dark:text-indigo-300 mb-2">
            <i class="fas fa-layer-group mr-1"></i>
            ${barangList.length} Barang
        </div>`;
        barangHTML += '<div class="space-y-1.5 max-h-48 overflow-y-auto custom-scrollbar pr-1">';
        barangList.forEach((item, index) => {
            barangHTML += `
                <div class="text-xs text-indigo-800 dark:text-indigo-300 bg-white dark:bg-gray-800 rounded p-2 border border-indigo-100 dark:border-indigo-800">
                    <span class="font-medium">${index + 1}.</span> ${item.nama} 
                    <span class="text-indigo-600 dark:text-indigo-400">(${item.jumlah}x)</span>
                    ${item.kategori ? `<span class="text-gray-500 dark:text-gray-400 ml-1">- ${item.kategori}</span>` : ''}
                </div>
            `;
        });
        ...
        barangHTML = `
            <div class="text-sm text-indigo-800 dark:text-indigo-300">
                <span class="font-medium">Barang:</span> ${item.nama}
                ${item.jumlah ? ` <span class="text-indigo-600 dark:text-indigo-400">(${item.jumlah}x)</span>` : ''}
            </div>
            ${item.kategori ? `
    ...
    barangContainer.innerHTML = barangHTML;
    document.getElementById('selesai-form').action = "/admin/peminjaman/" + id + "/selesai";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (approveForm) {
        approveForm.addEventListener('submit', function(e) {
            const confirmed = confirm('Apakah Anda yakin ingin menyetujui peminjaman ini?');
            if (!confirmed) {
                e.preventDefault();
                return false;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    logActivity('page_load', 'Peminjaman management page loaded');
});
