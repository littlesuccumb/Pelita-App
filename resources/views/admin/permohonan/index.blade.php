...
@section('title', 'Review Permohonan - Admin')
...
.animate-float {
    ...
    .badge-dalam-proses { background-color: #fef3c7; color: #92400e; }
...
<div class="w-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 lg:py-4">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-slate-600 dark:text-slate-400 text-lg flex items-center space-x-2">
                                ...
                                <span>Kelola dan review permohonan peminjaman dari user</span>
                            </p>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-3">
                                <div class="flex items-center space-x-2 px-4 py-2 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-slate-200/50 dark:border-gray-600/50 shadow-sm">
                                    <div class="p-1.5 bg-blue-100 dark:bg-blue-900/50 rounded-md">
                                        <i class="fas fa-clipboard-list text-blue-600 dark:text-blue-400 text-sm"></i>
                                    </div>
                                    <div>
                                        <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">Total Permohonan</p>
                                        <p class="text-lg font-bold text-slate-800 dark:text-slate-200">{{ $permohonan->total() }}</p>
                                    </div>
                                </div>
                                
                                <div class="flex items-center space-x-2 px-4 py-2 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-amber-200/50 dark:border-amber-800/50 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-bold text-slate-800 dark:text-slate-200">{{ $stats['dalam_proses'] ?? 0 }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row lg:flex-col gap-3">
                            {{-- Export Button --}}
                                     <a href="{{ route('admin.permohonan.export') }}" 
                                         class="group relative inline-flex items-center justify-center px-3 py-2 sm:px-6 sm:py-3.5 bg-white dark:bg-gray-700 hover:bg-slate-50 dark:hover:bg-gray-600 border-2 border-slate-200 dark:border-gray-600 hover:border-slate-300 dark:hover:border-gray-500 text-slate-700 dark:text-slate-200 font-semibold rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
        ...
        <div class="mb-8 animate-professional-reveal delay-200">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Status Permohonan</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Overview statistik permohonan real-time</p>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div class="relative p-4 sm:p-6">
                        ...
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-blue-100 text-xs font-medium">Semua permohonan</span>
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-amber-500 via-amber-600 to-orange-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div class="relative p-4 sm:p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $stats['dalam_proses'] ?? 0 }}</h3>
                                <span class="text-amber-100 text-sm">pending</span>
                            </div>
                        </div>
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-amber-100 text-xs font-medium">Menunggu review</span>
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-emerald-500 via-emerald-600 to-green-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div class="relative p-4 sm:p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $stats['disetujui'] ?? 0 }}</h3>
                                <span class="text-emerald-100 text-sm">approved</span>
                            </div>
                        </div>
                        <div class="mt-3 pt-3 border-t border-white/20 flex items-center justify-between">
                            <span class="text-emerald-100 text-xs font-medium">Berhasil disetujui</span>
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-red-500 via-red-600 to-rose-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div class="relative p-4 sm:p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-baseline gap-2">
                                <h3 class="text-2xl sm:text-3xl font-black text-white">{{ $stats['ditolak'] ?? 0 }}</h3>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400">Data diperbarui setiap kali ada perubahan status permohonan</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                {{ $stats['dalam_proses'] ?? 0 }} Perlu Review
                            </span>
                        </div>
                ...
                <div class="relative p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Filter data permohonan sesuai kebutuhan</p>
                        </div>
                    </div>
                    ...
                    <form method="GET" action="{{ route('admin.permohonan.index') }}">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" 
                                        ...
                                        placeholder="Cari nama pemohon, no permohonan..." 
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100">{{ $permohonan->total() }}</span>
                                <span class="text-sm text-gray-600 dark:text-gray-400">Permohonan</span>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <!-- Enhanced Data Table -->
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden animate-professional-reveal delay-400">
            <!-- Table Header -->
            <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Daftar Permohonan</h3>
                    </div>
                    <div class="text-sm text-gray-500 dark:text-gray-400">
                        {{ $permohonan->count() }} dari {{ $permohonan->total() }} data
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-slate-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-gray-800 dark:via-gray-800/95 dark:to-gray-800/90 divide-y divide-slate-100 dark:divide-gray-700">
                        ...
                        <tr class="table-row">
                            <td class="px-6 py-5">
                                <div>
                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $item->nama_pemohon }}</div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        <span class="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">{{ $item->no_permohonan }}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    <div class="relative flex-shrink-0">
                                        @if($item->user->avatar)
                                            <img src="{{ asset('storage/' . $item->user->avatar) }}" 
                                                alt="{{ $item->user->name }}"
                                                class="h-10 w-10 rounded-xl object-cover shadow-lg border-2 border-white dark:border-gray-700">
                                        @else
                                            <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
                                                <span class="text-white font-bold text-sm">{{ strtoupper(substr($item->user->name, 0, 2)) }}</span>
                                            </div>
                                        @endif
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $item->user->email }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5">
                                <div class="space-y-2">
                                    ...
                                    <!-- Items Count -->
                                    <div class="inline-flex items-center gap-1 px-2.5 py-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
                                        <i class="fas fa-box text-gray-500 dark:text-gray-400 text-xs"></i>
                                        <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">
                                            {{ $item->items->count() }} Barang
                                        </span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    @if($item->status == 'Dalam Proses')
                                    <button onclick="approveModal('{{ $item->id }}', '{{ $item->no_permohonan }}')"
                                    ...
                                    <button onclick="rejectModal('{{ $item->id }}', '{{ $item->no_permohonan }}')"
                        ...
                        <div class="flex justify-between items-start mb-4 pb-4 border-b border-slate-200 dark:border-gray-700">
                            <div class="flex items-center gap-3 flex-1 min-w-0">
                                <div class="relative flex-shrink-0">
                                    ...
                                    @else
                                        <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
                                            <span class="text-white font-bold">{{ strtoupper(substr($item->nama_pemohon, 0, 2)) }}</span>
                                        </div>
                                    @endif
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="text-sm font-bold text-gray-900 dark:text-gray-100 truncate">{{ $item->nama_pemohon }}</div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        <span class="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">{{ $item->no_permohonan }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="space-y-3 mb-4">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="bg-gradient-to-br from-green-50 to-emerald-50/50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-3 border border-green-200 dark:border-green-800">
                                    ...
                                    <div class="text-xs text-gray-700 dark:text-gray-300 font-medium mb-1 truncate" title="{{ $item->user->name }}">
                                        {{ $item->user->name }}
                                    </div>
                            ...
                            <!-- Items Info -->
                            <div class="bg-gradient-to-br from-purple-50 to-indigo-50/50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-xl p-3 border border-purple-200 dark:border-purple-800">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">Total Barang</div>
            ...
            <div class="bg-gradient-to-r from-slate-100 via-blue-50 to-indigo-50 dark:from-gray-700 dark:via-gray-800 dark:to-gray-700 px-6 py-6 border-t border-slate-200 dark:border-gray-600">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-3 px-4 py-2.5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 dark:border-gray-600">
                            ...
                            <div class="text-sm">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100 mx-1">{{ $permohonan->count() }}</span>
                                <span class="text-gray-600 dark:text-gray-400">dari</span>
                                <span class="font-bold text-blue-600 dark:text-blue-400 mx-1">{{ $permohonan->total() }}</span>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="hidden sm:flex items-center gap-2">
                            @foreach ($permohonan->getUrlRange(1, $permohonan->lastPage()) as $page => $url)
                                @if ($page == $permohonan->currentPage())
                        ...
                        <div class="sm:hidden px-4 py-2.5 bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-600 shadow-sm">
                            <span class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $permohonan->currentPage() }}</span>
                            <span class="text-sm text-gray-500 dark:text-gray-400 mx-1">/</span>
                            <span class="text-sm text-gray-600 dark:text-gray-300">{{ $permohonan->lastPage() }}</span>
                        </div>
                        
                        @if ($permohonan->hasMorePages())
                            <a href="{{ $permohonan->nextPageUrl() }}" 
                               class="px-4 py-2.5 bg-white dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 rounded-xl transition-all border border-slate-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-600 shadow-sm hover:shadow-md">
                    ...
                    <div class="hidden lg:flex items-center gap-3">
                        ...
                        <div class="relative">
                            <select id="page-select" onchange="window.location.href=this.value" 
                                ...
                                @for ($i = 1; $i <= $permohonan->lastPage(); $i++)
                                    <option value="{{ $permohonan->url($i) }}" {{ $i == $permohonan->currentPage() ? 'selected' : '' }}>
                                        {{ $i }}
                                    </option>
                                @endfor
                            </select>
                ...
                <div class="mt-4 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 h-full rounded-full transition-all duration-500 shadow-lg" 
                         style="width: {{ ($permohonan->currentPage() / $permohonan->lastPage()) * 100 }}%">
                    </div>
                </div>
                ...
                <div class="mt-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500 dark:text-gray-400">
                    <div class="flex items-center gap-4">
                        <span class="flex items-center gap-1.5">
                            ...
                            Per halaman: <strong class="text-gray-700 dark:text-gray-300">{{ $permohonan->count() }}</strong>
                        </span>
                        <span class="hidden sm:inline">•</span>
                        <span class="flex items-center gap-1.5">
                            <i class="fas fa-layer-group text-indigo-500 dark:text-indigo-400"></i>
                            Total halaman: <strong class="text-gray-700 dark:text-gray-300">{{ $permohonan->lastPage() }}</strong>
                        </span>
                    </div>
                    
                    <div class="flex items-center gap-2">
                        @if ($permohonan->currentPage() > 1)
                            <a href="{{ $permohonan->url(1) }}" 
                        ...
                        @if ($permohonan->currentPage() < $permohonan->lastPage())
                            <a href="{{ $permohonan->url($permohonan->lastPage()) }}" 
                               class="px-3 py-1.5 bg-white dark:bg-gray-800 hover:bg-slate-50 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-all text-xs font-medium border border-slate-200 dark:border-gray-600">
                                Akhir
            ...
            <div class="px-6 py-12 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Tidak ada permohonan</h3>
                <p class="text-gray-500 dark:text-gray-400 mb-6">
                    @if(request()->hasAny(['search', 'status']))
                        Tidak ditemukan permohonan yang sesuai dengan filter yang diterapkan.
                    @else
                ...
                @if(request()->hasAny(['search', 'status']))
                    <a href="{{ route('admin.permohonan.index') }}" 
                       class="inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-xl text-white bg-slate-600 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-all duration-200">
                        Reset Filter
                    </a>
                @endif
            </div>
            ...
            <div class="mt-3">
                ...
                <form id="approve-form" method="POST" action="">
                    ...
                    <div class="mb-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                        <p class="text-sm text-green-800 dark:text-green-300 mb-1 font-medium">Permohonan yang akan disetujui:</p>
                        <p id="approve-permohonan-no" class="font-semibold text-green-900 dark:text-green-200"></p>
                        <p class="text-xs text-green-600 dark:text-green-400 mt-2">
                            <i class="fas fa-info-circle mr-1"></i>
                            Peminjaman akan dibuat otomatis setelah disetujui
                        </p>
                    </div>
            ...
            <div class="mt-3">
                ...
                <form id="reject-form" method="POST" action="">
                    ...
                    <div class="mb-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                        <p class="text-sm text-red-800 dark:text-red-300 mb-1 font-medium">Permohonan yang akan ditolak:</p>
                        <p id="reject-permohonan-no" class="font-semibold text-red-900 dark:text-red-200"></p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alasan_penolakan" 
                                  ...
                                  minlength="10"
                                  maxlength="500"
                                  placeholder="Masukkan alasan penolakan permohonan (minimal 10 karakter)..."
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            <span id="char-count">0</span>/500 karakter (minimal 10)
                        </p>
                    </div>
...
@push('scripts')
<script>
function approveModal(id, noPermohonan) {
    document.getElementById('approve-permohonan-no').textContent = noPermohonan;
    document.getElementById('approve-form').action = "{{ url('admin/permohonan') }}/" + id + "/approve";
    document.getElementById('approve-modal').classList.remove('hidden');
}

function rejectModal(id, noPermohonan) {
    document.getElementById('reject-permohonan-no').textContent = noPermohonan;
    document.getElementById('reject-form').action = "{{ url('admin/permohonan') }}/" + id + "/reject";
...
if (textarea) {
    textarea.addEventListener('input', function() {
        ...
        if (count < 10) {
            ...
            countSpan.classList.remove('text-green-500');
        } else {
            countSpan.classList.add('text-green-500');
...
document.addEventListener('DOMContentLoaded', function() {
    // Validasi form approve
    const approveForm = document.getElementById('approve-form');
    if (approveForm) {
        approveForm.addEventListener('submit', function(e) {
            const noPermohonan = document.getElementById('approve-permohonan-no').textContent;
            
            if (!noPermohonan || noPermohonan.trim() === '') {
                e.preventDefault();
                alert('Error: Data permohonan tidak valid');
                return false;
            }
            
            const confirmed = confirm(`Apakah Anda yakin ingin menyetujui permohonan:\n"${noPermohonan}"\n\nPeminjaman akan dibuat otomatis setelah disetujui.`);
    ...
    if (rejectForm) {
        rejectForm.addEventListener('submit', function(e) {
            ...
            const noPermohonan = document.getElementById('reject-permohonan-no').textContent;
            ...
            const confirmed = confirm(`Apakah Anda yakin ingin menolak permohonan:\n"${noPermohonan}"\n\nAlasan: ${alasan.substring(0, 50)}${alasan.length > 50 ? '...' : ''}`);
